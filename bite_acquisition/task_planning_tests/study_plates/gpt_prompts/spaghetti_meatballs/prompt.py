...
class GPTPredictor:
    def __init__(self):
        ...
        self.prompt_img1 = cv2.imread(f"{self.home_dir}/example_imgs/1100_color.png")
        self.prompt_img2 = cv2.imread(f"{self.home_dir}/example_imgs/1108_color.png")
        self.prompt_img3 = cv2.imread(f"{self.home_dir}/example_imgs/1113_color.png")
        self.prompt_img4 = cv2.imread(f"{self.home_dir}/example_imgs/1118_color.png")
        self.prompt_img5 = cv2.imread(f"{self.home_dir}/example_imgs/1122_color.png")
        self.prompt_img6 = cv2.imread(f"{self.home_dir}/example_imgs/1130_color.png")
        self.prompt_img7 = cv2.imread(f"{self.home_dir}/example_imgs/1147_color.png")
        self.prompt_img8 = cv2.imread(f"{self.home_dir}/example_imgs/1166_color.png")  
        self.prompt_img9 = cv2.imread(f"{self.home_dir}/example_imgs/1167_color.png")
        self.prompt_img10 = cv2.imread(f"{self.home_dir}/example_imgs/1168_color.png")
