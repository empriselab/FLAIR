...
class GPTPredictor:
    def __init__(self):
        ...
        self.prompt_img1 = cv2.imread(f"{self.home_dir}/example_imgs/1003_color.png")
        self.prompt_img2 = cv2.imread(f"{self.home_dir}/example_imgs/1006_color.png")
        self.prompt_img3 = cv2.imread(f"{self.home_dir}/example_imgs/1010_color.png")
        self.prompt_img4 = cv2.imread(f"{self.home_dir}/example_imgs/1011_color.png")
        self.prompt_img5 = cv2.imread(f"{self.home_dir}/example_imgs/1018_color.png")
        self.prompt_img6 = cv2.imread(f"{self.home_dir}/example_imgs/1028_color.png")
        self.prompt_img7 = cv2.imread(f"{self.home_dir}/example_imgs/1030_color.png")
        self.prompt_img8 = cv2.imread(f"{self.home_dir}/example_imgs/1045_color.png")  
        self.prompt_img9 = cv2.imread(f"{self.home_dir}/example_imgs/1068_color.png")
        self.prompt_img10 = cv2.imread(f"{self.home_dir}/example_imgs/1094_color.png")
    ...
    def prompt(self, image, image_id = None, image_annotation = None):
        ...
        if response_text.startswith("TWIRL"):
            return "twirl"
        elif response_text.startswith("GROUP"):
            return "group"
        else:
            return "push"