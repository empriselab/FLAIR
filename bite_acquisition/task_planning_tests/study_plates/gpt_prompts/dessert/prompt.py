...
class GPTPredictor:
    def __init__(self):
        ...
        self.prompt_img1 = cv2.imread(f"{self.home_dir}/example_imgs/5_color.png")
        self.prompt_img2 = cv2.imread(f"{self.home_dir}/example_imgs/6_color.png")
        self.prompt_img3 = cv2.imread(f"{self.home_dir}/example_imgs/28_color.png")
        self.prompt_img4 = cv2.imread(f"{self.home_dir}/example_imgs/44_color.png")
        self.prompt_img5 = cv2.imread(f"{self.home_dir}/example_imgs/45_color.png")
        self.prompt_img6 = cv2.imread(f"{self.home_dir}/example_imgs/84_color.png")
        self.prompt_img7 = cv2.imread(f"{self.home_dir}/example_imgs/90_color.png")
        self.prompt_img8 = cv2.imread(f"{self.home_dir}/example_imgs/152_color.png")  
        self.prompt_img9 = cv2.imread(f"{self.home_dir}/example_imgs/160_color.png")
        self.prompt_img10 = cv2.imread(f"{self.home_dir}/example_imgs/171_color.png")
