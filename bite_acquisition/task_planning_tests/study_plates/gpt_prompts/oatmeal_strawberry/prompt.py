...
class GPTPredictor:
    def __init__(self):
        ...
        self.prompt_img1 = cv2.imread(f"{self.home_dir}/example_imgs/441_color.png")
        self.prompt_img2 = cv2.imread(f"{self.home_dir}/example_imgs/447_color.png")
        self.prompt_img3 = cv2.imread(f"{self.home_dir}/example_imgs/455_color.png")
        self.prompt_img4 = cv2.imread(f"{self.home_dir}/example_imgs/459_color.png")
        self.prompt_img5 = cv2.imread(f"{self.home_dir}/example_imgs/462_color.png")
        self.prompt_img6 = cv2.imread(f"{self.home_dir}/example_imgs/474_color.png")
        self.prompt_img7 = cv2.imread(f"{self.home_dir}/example_imgs/696_color.png")
        self.prompt_img8 = cv2.imread(f"{self.home_dir}/example_imgs/715_color.png")  
        self.prompt_img9 = cv2.imread(f"{self.home_dir}/example_imgs/721_color.png")
        self.prompt_img10 = cv2.imread(f"{self.home_dir}/example_imgs/726_color.png")
