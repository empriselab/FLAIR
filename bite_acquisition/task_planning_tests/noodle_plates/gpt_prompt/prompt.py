...
class GPTPredictor:
    def __init__(self):
        ...
        self.prompt_img1 = cv2.imread(f"{self.home_dir}/example_imgs/5.jpg")
        self.prompt_img2 = cv2.imread(f"{self.home_dir}/example_imgs/6.jpg")
        self.prompt_img3 = cv2.imread(f"{self.home_dir}/example_imgs/8.jpg")
        self.prompt_img4 = cv2.imread(f"{self.home_dir}/example_imgs/11.jpg")
        self.prompt_img5 = cv2.imread(f"{self.home_dir}/example_imgs/14.jpg")
        self.prompt_img6 = cv2.imread(f"{self.home_dir}/example_imgs/27.jpg")
        self.prompt_img7 = cv2.imread(f"{self.home_dir}/example_imgs/66.jpg")
        self.prompt_img8 = cv2.imread(f"{self.home_dir}/example_imgs/69.jpg")  
        self.prompt_img9 = cv2.imread(f"{self.home_dir}/example_imgs/81.jpg")
        self.prompt_img10 = cv2.imread(f"{self.home_dir}/example_imgs/96.jpg")
